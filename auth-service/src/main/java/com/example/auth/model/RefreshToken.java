...
public class RefreshToken {
 ...
 private LocalDateTime createdAt; private LocalDateTime revokedAt; private String replacedByHash;
 ...
 public LocalDateTime getExpiresAt(){return expiresAt;} public LocalDateTime getCreatedAt(){return createdAt;} public LocalDateTime getRevokedAt(){return revokedAt;}
 public boolean isRevoked(){return revoked;} public void setRevoked(boolean v){revoked=v;if(v&&revokedAt==null)revokedAt=LocalDateTime.now();}
